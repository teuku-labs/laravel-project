...
<head>
    ...
    <title>Mahasiswa Bimbingan - Dekan</title>
...
<div class="main">
    <nav class="topbar">
        ...
        <div style="display:flex;align-items:center;gap:.75rem;"><div class="avatar">{{ substr($dekan->nama ?? 'K', 0, 1) }}</div><div><div style="font-weight:600;font-size:.9rem;">{{ $dekan->nama }}</div><div style="font-size:.75rem;color:var(--muted);">Dekan</div></div></div>
    </nav>
    ...
    <div class="content">
        ...
        <div class="pengajuan-card">
            ...
            <div class="pengajuan-info">
                ...
                <div class="pengajuan-detail">NIM: {{ $p->mahasiswa->nim ?? '-' }} &nbsp;·&nbsp; {{ $p->mahasiswa->prodi->nama ?? '-' }}</div>
            ...
            <div style="display:flex;flex-direction:column;gap:.5rem;align-items:flex-end;">
                <form action="{{ route('dekan.bimbingan.approve', $p->id) }}" method="POST">
                    @csrf
            ...
            <table class="custom-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $m->prodi->nama ?? '-' }}</td>
                        <td>
                            @if($m->pembimbing1_id == $dekan->user_id)
...
<script>
    ...
    document.getElementById('rejectModal').addEventListener('show.bs.modal', function(e) {
        ...
        document.getElementById('rejectForm').action = '/dekan/bimbingan/' + btn.getAttribute('data-id') + '/reject';
    });
</script>
</body>
</html>