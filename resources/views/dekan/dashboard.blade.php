...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <a href="{{ route('dekan.dashboard') }}" class="menu-item active"><i class="fas fa-home"></i>Dashboard</a>
...
<div class="main">
    ...
    <div class="content">
        <div style="margin-bottom:2rem;"><h2 style="font-weight:700;">Dashboard Dekan</h2><p style="color:var(--muted);font-size:.9rem;">Pantau seluruh aktivitas seminar mahasiswa.</p></div>
        <div class="stats-grid">
            <div class="stat-card"><div class="stat-icon" style="background:rgba(225,112,85,.12);color:var(--primary)"><i class="fas fa-user-graduate"></i></div><div><div class="stat-value">{{ $totalMahasiswa }}</div><div class="stat-label">Total Mahasiswa</div></div></div>
            <div class="stat-card"><div class="stat-icon" style="background:rgba(39,174,96,.12);color:#27ae60"><i class="fas fa-file-alt"></i></div><div><div class="stat-value">{{ $totalSeminar }}</div><div class="stat-label">Daftar Seminar LKP</div></div></div>
            <div class="stat-card"><div class="stat-icon" style="background:rgba(52,152,219,.12);color:#3498db"><i class="fas fa-calendar-check"></i></div><div><div class="stat-value">{{ $sudahDijadwal }}</div><div class="stat-label">Sudah Dijadwal</div></div></div>
            <div class="stat-card"><div class="stat-icon" style="background:rgba(243,156,18,.12);color:#f39c12"><i class="fas fa-clock"></i></div><div><div class="stat-value">{{ $belumDijadwal }}</div><div class="stat-label">Belum Dijadwal</div></div></div>
        </div>
