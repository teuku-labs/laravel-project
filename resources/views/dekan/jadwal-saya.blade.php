...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;}body{font-family:'Poppins',sans-serif;background:var(--bg);color:var(--text);}
        ...
        .badge-jenis{background:rgba(225,112,85,.15);color:var(--dark);padding:.3rem .8rem;border-radius:20px;font-size:.73rem;font-weight:500;text-transform:capitalize;}
