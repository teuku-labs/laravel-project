...
<div style="margin-bottom:2rem;">
    ...
    <h2 style="font-weight:700;margin-top:.5rem;">Tambah Dekan</h2>
</div>
@if($errors->any())
...
<div class="table-card" style="max-width:600px;">
    <form action="{{ route('admin.dekan.store') }}" method="POST">
        ...
        <div style="display:flex;flex-direction:column;gap:1.25rem;">
            ...
            <div style="background:#fdf0ee;border-radius:10px;padding:1rem;font-size:.85rem;color:#c0392b;">
            ...
            <button type="submit" style="background:linear-gradient(135deg,var(--primary-green),var(--dark-green));color:white;border:none;padding:.85rem;border-radius:12px;font-weight:600;font-family:'Poppins',sans-serif;cursor:pointer;">
                <i class="fas fa-save"></i> Simpan Dekan
            </button>
        </div>
    </form>
</div>
