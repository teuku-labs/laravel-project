...
<head>
    ...
    <title>Nilai Sidang Skripsi - Dosen</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <a href="{{ route('dosen.nilai-lkp.index') }}" class="menu-item"><i class="fas fa-star-half-alt"></i>Nilai Sidang Skripsi</a>
        <a href="{{ route('dosen.nilai-proposal.index') }}" class="menu-item"><i class="fas fa-star-half-alt"></i>Nilai Seminar Proposal</a>
        <a href="{{ route('dosen.nilai-sidang.index') }}" class="menu-item active"><i class="fas fa-star-half-alt"></i>Nilai Sidang Skripsi</a>
...
<div class="main">
    <nav class="topbar">
        <div style="display:flex;align-items:center;gap:1rem;"><button class="toggle-btn" id="sidebarToggle"><i class="fas fa-bars"></i></button><span style="font-weight:600;font-size:.95rem;">Nilai Sidang Skripsi</span></div>
    ...
    <div class="content">
        ...
        <div class="table-card">
            <div class="table-header">
                <div>
                    ...
                    <p style="color:var(--muted);font-size:.83rem;margin:0;">Mahasiswa yang Anda bimbing &middot; Total: {{ $sidangList->count() }}</p>
                </div>
            ...
            <div class="table-responsive">
                <table class="custom-table" id="nilaiTable">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="10"><div class="empty-state"><i class="fas fa-inbox"></i><p>Belum ada sidang skripsi yang Anda bimbing.</p></div></td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
        ...
        @foreach($sidangList as $sd)
            <form id="form-nilai-{{ $sd->id }}" action="{{ route('dosen.nilai-sidang.store', $sd->id) }}" method="POST" style="display:none;">@csrf</form>
        @endforeach
    </div>
</div>
